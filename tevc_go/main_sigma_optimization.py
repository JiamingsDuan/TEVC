...
# 加载训练数据
train_dataset = np.loadtxt('./dataset/10fold/pittsburg-bridges-t-or-d/pittsburg-bridges-t-or-d-10-5tra.dat',
                           delimiter=',')
train_data_index = []
...
# 加载测试数据
test_dataset = np.loadtxt('./dataset/10fold/pittsburg-bridges-t-or-d/pittsburg-bridges-t-or-d-10-5tst.dat',
                          delimiter=',')
test_data_index = []
...
for iteration in range(0, iterations):
    ...
    colors = ['#DD3429', '#139174', '#2E4075', '#CC99FF', '#9933FF']
    markers = ['o', 's', '^', '+', 'p']
